...
This sequence assigns 1973 to the first instance of year; then 1974 to the second instance.  This pattern is repeated for all rows in the data frame.
...
use this code: cond <- mtcars$wt < 3
if mtcars$wt is less than 3, the value of TRUE is assigned to vector cond; 
else the value of FALSE is assigned to the vectoro cond.

mtcars$weight_class <- ifelse(cond, 'light', 'average')
This code uses ifelse.  If the cond it TRUE, 'light' is assigned
to the weight_class variable; else 'average' is assigned to the weight_class variable.
